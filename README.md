...
- Install with CloudFront `https://cdn.zigurous.com/forge-css@1.2.1/dist/index.min.css`
- Install with jsDelivr `https://cdn.jsdelivr.net/gh/zigurous/forge-css@1.2.1/dist/index.min.css`
- Install with Statically `https://cdn.statically.io/gh/zigurous/forge-css/1.2.1/dist/index.min.css`

Link to the stylesheet in your HTML file:
```html
<link href="https://cdn.zigurous.com/forge-css@1.2.1/dist/index.min.css" rel="stylesheet">
```
